...
<!-- Mirrored from techshopbd.com/category-list by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Mar 2022 13:25:43 GMT -->
            ...
            <ul class="navbar-nav ml-0">
                <li class="nav-item pl-0">
                    <div class="header-category">
                        <button type="button" class="text-uppercase" id="js--btn-category"><img src="{{ asset('image/frontLogos/category-icon.png') }}" alt="icon"> Categories</button>
                        <ul class="header-category-list" id="js--category-list">
